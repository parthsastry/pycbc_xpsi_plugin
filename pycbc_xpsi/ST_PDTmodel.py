...
class XPSI_ST_PDTModel(BaseModel):
    """Model wrapper around XPSI likelihood function."""
    name = 'pycbc_xpsi_st_pdt'
    ...
    def apply_additional_constraints(self):
        ...
        # Following copied from ST_PDT/NICER/STPDT..../CustomPrior_H.py
    ...
    def from_config(cls, cp, **kwargs):
        ...
        #     xmm = xmm_from_config(cp, interstellar)
        #     signals.append(xmm.signal)
        # load the spacetime
...
def hotregions_from_config(cp):
    ...
    hotspots_bounds = {
        ...
        's': dict(
            ...
            phase_shift=(-0.25, 0.75),
            super_temperature=(5.1, 6.8),
            cede_colatitude = (0.0, numpy.pi-0.001),
